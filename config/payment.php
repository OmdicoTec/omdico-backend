...
return [
    ...
    */
    'drivers' => [
        'local' => [
            'callbackUrl' => 'http://localhost:8000/api/pay/callback',
        ...
        'idpay' => [
            ...
            'merchantId' => '2975d37d-1bd5-4560-9df7-e60e6adf7700',
            // 'callbackUrl' => 'http://localhost:8000/api/pay/callback',
            'callbackUrl' => env('PAY_CALLBACK'),
        ...
        'zibal' => [
            ...
            'merchantId' => 'zibal',
            'callbackUrl' => 'http://localhost:8000/api/pay/callback',
            'description' => 'پرداخت به وبسایت عمدیکو.',
            'currency' => 'T', //Can be R, T (Rial, Toman)
        ],
        'sepordeh' => [
